...
if (isset($student)) {
    ...
    $student_address = set_value('student_address');
}
?>
          ...
          <div class="row">
            ...
            <div class="col-sm-9 col-md-3">
                <div class="form-group">
                    ...
                    <?php if (isset($student)): ?>
                       <button type="button" onclick="doDelete(<?php echo $student['student_id'] ?>)" class="btn btn-danger"> <i class="fa fa-trash"></i> Hapus</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
